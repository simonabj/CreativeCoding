""" from https://github.com/R2D2FISH/glados-tts """
...
from tools.text.numbers import normalize_numbers
from tools.text.symbols import phonemes_set
...
class Cleaner:
    def __init__(self,
        ...
        self.lang = lang
        if use_phonemes:
            self.phonemize = Phonemizer.from_checkpoint(f'{self.model_dir}/en_us_cmudict_ipa_forward.pt')
